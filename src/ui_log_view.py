...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.checkBox_openOnStartup = QCheckBox(Dialog)
        self.checkBox_openOnStartup.setObjectName(u"checkBox_openOnStartup")

        self.horizontalLayout.addWidget(self.checkBox_openOnStartup)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 537, 255))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBox_openOnStartup.setText(QCoreApplication.translate("Dialog", u"Open on startup", None))
    # retranslateUi
